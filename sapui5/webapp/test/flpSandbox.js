		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#belerofontesapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"belerofontesapui5-display": {
								"semanticObject": "belerofontesapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=belerofonte.sapui5",
									"url": sap.ui.require.toUrl("belerofonte/sapui5")
								}
							}
						}
					}
